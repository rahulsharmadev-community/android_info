...
class AndroidDeviceInfo {
  ...
  /// Information about the current android buildId.
  final AndroidbuildIdMetrics buildIdMetrics;
  ...
  /// This method returns the time in milliseconds since the device was
  ///  last booted, including time spent in sleep mode.
  ...
  static AndroidDeviceInfo fromMap(Map<String, dynamic> map) {
    return AndroidDeviceInfo._(
      ...
      buildIdMetrics: AndroidbuildIdMetrics._fromMap(
          map['displayMetrics']?.cast<String, dynamic>() ?? {}),
      serialNumber: map['serialNumber'],
      elapsedRealtime: map['elapsedRealtime'],
    );
  }
...
/// Details for the current buildId
///
/// See: https://developer.android.com/reference/android/util/buildIdMetrics
class AndroidbuildIdMetrics {
  const AndroidbuildIdMetrics._(
      {required this.widthPx,
      required this.heightPx,
      required this.xDpi,
      required this.yDpi,
      required this.refreshRate,
      required this.isHdrSupport});

  final int refreshRate;
  final bool isHdrSupport;

  /// Gets the absolute width in pixels of the largest region of the buildId accessible to an app
  /// in the current system state, without subtracting any window decor or applying scaling factors.
  final double widthPx;

  /// Gets the absolute height in pixels of the largest region of the buildId accessible to an app
  /// in the current system state, without subtracting any window decor or applying scaling factors.
  ...
  /// The exact physical buildId width in inches.
  double get widthInches => widthPx / xDpi;

  /// The exact physical buildId height in inches.
  double get heightInches => heightPx / yDpi;

  /// The exact physical size in inches measured diagonally across the buildId.
  ...
  /// Serializes [AndroidbuildIdMetrics] to map.
  Map<String, dynamic> toMap() {
    return {
      'widthPx': widthPx,
      'heightPx': heightPx,
      ...
      'isHdrSupport': isHdrSupport
    };
  }

  /// Deserializes from the map message received from the [MethodChannel].
  static AndroidbuildIdMetrics _fromMap(Map<String, dynamic> map) {
    return AndroidbuildIdMetrics._(
        widthPx: map['widthPx'],
        heightPx: map['heightPx'],
        xDpi: map['xDpi'],
        yDpi: map['yDpi'],
        refreshRate: map['refreshRate'],
        isHdrSupport: map['isHdrSupport']);
  }
}
